...
export default function Home() {
  return (
    <main className="flex h-auto dark:bg-black bg-white flex-col items-center justify-center py-12">
      ...
      <div className="fsec h-auto py-24 px-0 flex flex-col lg:flex-row items-center justify-center">
        <Image
          width={100}
          height={100}
          ...
          alt="logo"
          unoptimized
          className=" w-full h-auto lg:h-96 lg:w-auto md:w-[50vw] dark:hidden "
        />
        <Image
          width={100}
          height={100}
      ...
      <div className="lg:flex">
        ...
        <div className="tsec px-12 lg:px-6 h-auto w-full text-left md:w-[50vw] lg:w-[40vw] pb-32 flex flex-col items-center justify-center">
